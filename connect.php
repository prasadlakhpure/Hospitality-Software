...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_POST['submit'] == 'update') {
        $id = $_POST['id']; // Add this line to retrieve the id
        $sql = "UPDATE booking SET 
                ...
                totalAmount='$totalAmount', paymentMode='$paymentMode', debitCardNumber='$debitCardNumber', debitCardHolder='$debitCardHolder', 
                debitCardExpiry='$debitCardExpiry', debitCardCVV='$debitCardCVV', 
                creditCardType='$creditCardType', creditCardNumber='$creditCardNumber', 
                creditCardHolder='$creditCardHolder', creditCardExpiry='$creditCardExpiry', 
                creditCardCVV='$creditCardCVV', Upiid='$upiId'
                WHERE id=$id";
